...
export function render(slot,data,request,reload){
  ...
  void import("./performance-resilience-lab.js").then(m=>m.render(slot.querySelector("#ct-performance-lab"),request)).catch(()=>{const x=slot.querySelector("#ct-performance-lab");if(x)x.innerHTML='<p class="ct-note">Performance & Resilience Lab indisponible.</p>';});
}
