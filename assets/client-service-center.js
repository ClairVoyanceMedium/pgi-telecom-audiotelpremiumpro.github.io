...
export function createController({api,reload,toast,locale}){
  ...
  async function submit(e){
    ...
    try{
      ...
      toast("Dossier créé. PGI suivra son avancement dans cet espace.");
