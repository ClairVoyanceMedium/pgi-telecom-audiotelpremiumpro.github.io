...
controlTower:function(){return request("/platform/control-tower");},
evaluatePolicy:function(p){return request("/platform/policy/evaluate",{method:"POST",body:p||{}});},
simulateDigitalTwin:function(p){return request("/platform/digital-twin/simulate",{method:"POST",body:p||{}});},
