...
customerRelationsQueue:function(params){var q=new URLSearchParams(params||{}).toString();return request("/platform/customer-relations/queue"+(q?"?"+q:""));},
tenantCustomerRelations:function(id){return request("/platform/tenants/"+encodeURIComponent(id)+"/customer-relations",{timeoutMs:10000});},
