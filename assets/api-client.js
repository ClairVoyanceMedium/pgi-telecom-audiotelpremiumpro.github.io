...
tenantInternalNotes:id=>request("/platform/tenants/"+encodeURIComponent(id)+"/internal-notes"),
addTenantInternalNote:function(id,p,k){return idem("/platform/tenants/"+encodeURIComponent(id)+"/internal-notes",p,k);},
archiveTenantInternalNote:function(id,k){return idem("/platform/tenant-internal-notes/"+encodeURIComponent(id)+"/archive",{},k);},
