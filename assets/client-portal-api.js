...
root.PGICustomerApi=Object.freeze({
  ...
  team:function(){return request("/customer/team",{timeoutMs:8000});},
  inviteTeamMember:function(payload,idempotencyKey){return request("/customer/team/invitations",{method:"POST",body:payload,idempotencyKey:idempotencyKey});},
  updateTeamMember:function(id,payload){return request("/customer/team/members/"+encodeURIComponent(id),{method:"PATCH",body:payload});},
  revokeTeamInvitation:function(id){return request("/customer/team/invitations/"+encodeURIComponent(id)+"/revoke",{method:"POST",body:{}});},
