...
export async function enroll(api,label="Passkey",currentPassword=""){
  ...
  return api.passkeyRegister({state:o.state,credential_id:e(cred.rawId),client_data_json:e(r.clientDataJSON),authenticator_data:e(ad),public_key_spki:e(pk),transports:typeof r.getTransports==="function"?r.getTransports():[],label,current_password:currentPassword});
}
