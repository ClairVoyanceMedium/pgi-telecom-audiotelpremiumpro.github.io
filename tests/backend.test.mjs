  ...
  try{
    const response=await fetch(base+"/api/v1/customer/auth/register",{
      ...
      body:JSON.stringify({
        ...
        password:"long-password-12345",authority_confirmed:true,legal_terms_accepted:true,privacy_notice_acknowledged:true,legal_version:"2026-09-26-b2b-b2c-v4",website:"",preferred_locale:"fr-FR",timezone:"Europe/Paris"
      })
    });
