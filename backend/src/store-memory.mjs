...
export class MemoryStore{
  ...
  async selfServiceRegister(input={},passwordHash){
    ...
    if(String(input.legal_version||"")!=="2026-09-26-b2b-b2c-v2")throw problem(409,"LEGAL_DOCUMENT_VERSION_OUTDATED");
    this.customerLegalAcceptances.push({acceptance_type:"account_terms",document_version:"2026-09-26-b2b-b2c-v2",documents:{cgu:"/conditions-utilisation/",conditions:"/conditions-abonnement/",privacy:"/confidentialite/",cookies:"/cookies-traceurs/"},account_type:accountType,evidence:{source:"self_service_registration",authority_confirmed:true,privacy_notice_acknowledged:true},accepted_at:new Date().toISOString()});
