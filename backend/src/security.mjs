...
export function sessionCookie(token,maxAge){
  return "__Host-__Host-pgi_session="+encodeURIComponent(token)+"; Path=/; HttpOnly; Secure; SameSite=Strict; Max-Age="+maxAge;
}
export function csrfCookie(token,maxAge){
  return "__Host-__Host-pgi_csrf="+encodeURIComponent(token)+"; Path=/; Secure; SameSite=Strict; Max-Age="+maxAge;
}
export function clearSessionCookies(){
  return [
    "__Host-__Host-pgi_session=; Path=/; HttpOnly; Secure; SameSite=Strict; Max-Age=0",
    "__Host-__Host-pgi_csrf=; Path=/; Secure; SameSite=Strict; Max-Age=0"
  ];
}
