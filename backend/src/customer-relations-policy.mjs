...
const POLICIES=Object.freeze({
  ...
  respond_customer:{risk_class:"low",execution_mode:"automatic"},
  request_customer_info:{risk_class:"low",execution_mode:"automatic"},
  prepare_mediation:{risk_class:"low",execution_mode:"automatic"},
  ...
  request_outbound_rio:{risk_class:"medium",execution_mode:"external_confirmation"},
  submit_port_out:{risk_class:"high",execution_mode:"external_confirmation"},
  request_port_out_report:{risk_class:"medium",execution_mode:"external_confirmation"},
  request_port_out_cancel:{risk_class:"high",execution_mode:"external_confirmation"},
...
export function relationNextActions(c={},exitRequest=null){
  ...
  if(String(c.customer_capacity||"unknown")==="consumer")actions.push("prepare_mediation");
...
export function safeAgentContext(c={},evidence=[],actions=[],exitRequest=null,events=[]){
  return {
