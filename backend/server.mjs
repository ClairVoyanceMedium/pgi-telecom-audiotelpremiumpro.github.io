  ...
  const server=http.createServer(async(req,res)=>{
    ...
    try{
      ...
      if(method==="POST"&&pathname==="/api/v1/customer/billing/checkout-session"){
        ...
        if(String(legal.legal_version||"")!=="2026-09-26"){const e=new Error("Legal document version outdated");e.status=409;e.code="LEGAL_DOCUMENT_VERSION_OUTDATED";throw e;}
        const context=await store.customerSessionContext(customerActor);
        ...
        const payload={tenant_id:context.tenant_id,price_version_id:billing.offer.price_version_id,provider:"stripe",legal_version:"2026-09-26",immediate_performance_requested:true};
        const result=await store.idempotent(checkoutIdempotencyKey,"customer.billing.checkout",payload,async()=>{
          ...
          await store.recordCustomerLegalAcceptance(context.tenant_id,context.id,{
            acceptance_type:"subscription_checkout",document_version:"2026-09-26",
