...
if(!/\/api\/v1\/platform\/control-tower/.test(backendServer)||!/controlTowerOverview/.test(postgresStore)||!/audiotel-control-tower\/1/.test(postgresStore))failures.push("production must retain the Control Tower aggregate");
